 ...
 * Use the {@link AdventureEditFragment#newInstance} factory method to
...
public class AdventureEditFragment extends Fragment {
    ...
    public static AdventureEditFragment newInstance(String param1, String param2) {
        AdventureEditFragment fragment = new AdventureEditFragment();
